...
- 查碼支援至中日韓統一表意文字擴充區 D，總數超過七萬五千字符
...
- 查碼頁面顯示近期搜尋（並能夠清空）
- 打字頁面能隱藏打字表現、可暫停計時
- 記憶查碼、打字頁面的偏好設定以及打字頁面當前題目

#### 2021/01/01

- 大幅更新首頁互動鍵盤彩蛋系統、彩蛋指引設計與鍵盤外觀設計

#### 2020/12/23(22)

- 查碼頁面提供行列 10 的編碼
- 打字練習的當前提示增加了顯示拆字的功能（最多顯示一種標準拆法）
- 修正打字練習結束可再激活計時器的問題（非嚴重）

#### 2020/12/05(04)

- 查碼頁面改以分批載入大量的搜尋結果（一次最多 100 筆），以緩解圖片載入的耗時
...
- 打字頁面將設定與說明放入 modal 選單中、更清楚呈現打字結果
- 打字頁面顯示隱藏某物件時是顯示隱藏整個區塊（包含標題、空白空間）
- 更改打字頁面頁頭與頁面主體背景顏色
...
- 首頁互動鍵盤能在 firefox 上良好顯示了

#### 2021/01/01

- 大幅更新首頁互動鍵盤彩蛋系統、彩蛋指引設計與鍵盤外觀設計
- 首頁互動鍵盤文字慶祝 2021 新的一年！

#### 2020/12/05

- 加入新的支持網站管道（綠界科技），因為臺灣尚未支援 buy me a coffee (paypal)

#### 2020/12/05(04)

- 更新打字練習題目顯示樣式，移除題目尾聲提示，加上當前練習以及下一句的標題

#### 2020/12/04(03)

- 更新打字練習題目顯示樣式，並在題目尾聲加上提示

#### 2020/12/02

- 查碼頁面結果超連結、打字頁面錯誤字超連結、字根表頁面字根與字根碼超連結，游標經過順暢放大顯示
- 暫時移除查碼頁面的重碼冷知識
- 快速入門加入行列鍵盤圖片
